...
<style type="text/css">
	*{ font-family: sans-serif; }
	...
	<div class="main">
		<h3 style="color: blue">Quản lí Nhà Sản Xuất</h3>
		...
		<div class="main-content">
			...
			<div class="right">
				<form method="post" action="{{route('producer.postAdd')}}">
					@csrf
					<input type="text" name="code" class="form-contro" autocomplete="off" placeholder="Nhập mã nhà sản xuất...">

					<input type="text" name="name" class="form-contro" autocomplete="off" placeholder="Nhập tên nhà sản xuất...">
					<br>
	...
	<script type="text/javascript">
        ...
        function del(id){
        	$.ajax({
        		...
        		type:'post',
        		url: 'http://127.0.0.1:8000/admin/producer/delete',
        		data:{id:id},
